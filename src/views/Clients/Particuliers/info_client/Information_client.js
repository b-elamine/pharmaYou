...
class Client_Info extends React.Component {
  ...
  // fetcher_data = async (id_client) => {
  //   try {
  //     const res = await axios.get(
  //       `users/${id_client}?access_token=a&type=infirmier`
  //     );
  //     const client = {
  ...
  // };
  // componentDidMount(){
  //   const id_client = this.props.match.params.id_client; 
  //   this.fetcher_data(id_client)
  // }
  render() {
                ...
                <Media body>
                  ...
                  <div className="d-flex flex-sm-row flex-column justify-content-start px-0">
                    <Button.Ripple
                      ...
                      onClick={() => {
                        history.push(
                          "/client/particuliers/modifier_Client",
                          this.state.row
                        );
                      }}
                    >
