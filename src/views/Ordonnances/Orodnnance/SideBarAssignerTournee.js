...
class ComposeEmail extends React.Component {
  state = {
    ...
    listeTournes: "",
    email_title:
      `[Commande ${this.props.ordonnance.id}] Votre commande a \u00e9t\u00e9 valid\u00e9e`,
    email_text:
          ...
          <CardBody className="compose-mail-body p-1">
            ...
            <div style={{ marginBottom: "50px" }}>
              ...
              <div id="email-notif" style={{ marginTop: "20px" }}>
                ...
                ></Input>
                <label style={{ fontSize: "13px", marginTop:"15px" }}>Text de l'email</label>
                <Input
                  id="email_text"
                  type="textarea"
                  rows="6"
                ...
                ></Input>
                <label style={{ fontSize: "13px", marginTop:"15px" }}>Sms text</label>
                <Input
                  id="sms_text"
                  type="textarea"
                  rows="1"
                ...
                ></Input>
                <label style={{ fontSize: "13px", marginTop:"15px" }}>Notification text</label>
                <Input
